...
<nav class="navbar navbar-expand-sm bg-info navbar-dark mb-4">
  <a class="navbar-brand" href="home.php">yTasks - Gestão de Tarefas</a>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          ...
          <a class="dropdown-item" href="cliente.php">Nova</a>
        </div>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="logout.php">Terminar sessão <?php if(isset($_SESSION["username"])) echo $_SESSION["username"]; ?></a>
      </li>
    </ul>
  </div>
</nav>
